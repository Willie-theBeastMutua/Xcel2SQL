...
--
-- Table structure for table `hiv_me_post_test`
--

DROP TABLE IF EXISTS `hiv_me_post_test`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hiv_me_post_test` (
...
--
-- Dumping data for table `hiv_me_post_test`
--

LOCK TABLES `hiv_me_post_test` WRITE;
/*!40000 ALTER TABLE `hiv_me_post_test` DISABLE KEYS */;
/*!40000 ALTER TABLE `hiv_me_post_test` ENABLE KEYS */;
UNLOCK TABLES;
