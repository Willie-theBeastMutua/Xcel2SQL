...
--
-- Table structure for table `hiv_me_users`
--

DROP TABLE IF EXISTS `hiv_me_users`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hiv_me_users` (
...
--
-- Dumping data for table `hiv_me_users`
--

LOCK TABLES `hiv_me_users` WRITE;
/*!40000 ALTER TABLE `hiv_me_users` DISABLE KEYS */;
/*!40000 ALTER TABLE `hiv_me_users` ENABLE KEYS */;
UNLOCK TABLES;
