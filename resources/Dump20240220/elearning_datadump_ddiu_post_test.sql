...
--
-- Table structure for table `ddiu_post_test`
--

DROP TABLE IF EXISTS `ddiu_post_test`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ddiu_post_test` (
...
--
-- Dumping data for table `ddiu_post_test`
--

LOCK TABLES `ddiu_post_test` WRITE;
/*!40000 ALTER TABLE `ddiu_post_test` DISABLE KEYS */;
/*!40000 ALTER TABLE `ddiu_post_test` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2024-02-20 12:44:25
