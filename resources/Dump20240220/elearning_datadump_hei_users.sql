...
--
-- Table structure for table `hei_users`
--

DROP TABLE IF EXISTS `hei_users`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hei_users` (
...
--
-- Dumping data for table `hei_users`
--

LOCK TABLES `hei_users` WRITE;
/*!40000 ALTER TABLE `hei_users` DISABLE KEYS */;
/*!40000 ALTER TABLE `hei_users` ENABLE KEYS */;
UNLOCK TABLES;
