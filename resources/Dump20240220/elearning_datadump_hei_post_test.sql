...
--
-- Table structure for table `hei_post_test`
--

DROP TABLE IF EXISTS `hei_post_test`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hei_post_test` (
...
--
-- Dumping data for table `hei_post_test`
--

LOCK TABLES `hei_post_test` WRITE;
/*!40000 ALTER TABLE `hei_post_test` DISABLE KEYS */;
/*!40000 ALTER TABLE `hei_post_test` ENABLE KEYS */;
UNLOCK TABLES;
