...
--
-- Table structure for table `hei_survey`
--

DROP TABLE IF EXISTS `hei_survey`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hei_survey` (
  ...
  `Q00_Carder-other` varchar(200) DEFAULT NULL,
  ...
  `Q02_Motivations for eLearning` varchar(800) DEFAULT NULL,
...
--
-- Dumping data for table `hei_survey`
--

LOCK TABLES `hei_survey` WRITE;
/*!40000 ALTER TABLE `hei_survey` DISABLE KEYS */;
/*!40000 ALTER TABLE `hei_survey` ENABLE KEYS */;
UNLOCK TABLES;
