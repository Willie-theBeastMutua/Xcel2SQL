...
--
-- Table structure for table `art_pre_test`
--

DROP TABLE IF EXISTS `art_pre_test`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `art_pre_test` (
...
--
-- Dumping data for table `art_pre_test`
--

LOCK TABLES `art_pre_test` WRITE;
/*!40000 ALTER TABLE `art_pre_test` DISABLE KEYS */;
/*!40000 ALTER TABLE `art_pre_test` ENABLE KEYS */;
UNLOCK TABLES;
