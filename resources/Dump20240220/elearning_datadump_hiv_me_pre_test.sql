...
--
-- Table structure for table `hiv_me_pre_test`
--

DROP TABLE IF EXISTS `hiv_me_pre_test`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `hiv_me_pre_test` (
...
--
-- Dumping data for table `hiv_me_pre_test`
--

LOCK TABLES `hiv_me_pre_test` WRITE;
/*!40000 ALTER TABLE `hiv_me_pre_test` DISABLE KEYS */;
/*!40000 ALTER TABLE `hiv_me_pre_test` ENABLE KEYS */;
UNLOCK TABLES;
