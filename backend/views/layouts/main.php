...
$this->registerCssFile('@web/vendor/twbs/bootstrap/dist/css/bootstrap.min.css');

// Link Bootstrap JS (including Popper.js for Bootstrap 4)
$this->registerJsFile('@web/vendor/twbs/bootstrap/dist/js/bootstrap.bundle.min.js', ['depends' => ['yii\web\YiiAsset']]);
