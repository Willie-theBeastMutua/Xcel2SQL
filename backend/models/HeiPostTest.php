...
/**
 * This is the model class for table "hei_post_test".
 *
 ...
 */
class HeiPostTest extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
	...
	{
		return parent::find()->andWhere(['=', 'hei_post_test.deleted', 0]);
	}
    ...
    public function rules()
    {
        return [
            ...
            [['Last name', 'First name', 'Email address', 'City', 'Country', 'State', 'Started on', 'Completed', 'Time taken', 'Grade/100', 'Q1', 'Q2', 'Q3', 'Q4', 'Q5', 'Q6', 'Q7', 'Q8', 'Q9'], 'string', 'max' => 200],
