...
/**
 * This is the model class for table "ddiu_users".
 *
 * @property string $id
 ...
 */
class DdiuUsers extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
	...
	{
		return parent::find()->andWhere(['=', 'ddiu_users.deleted', 0]);
	}
