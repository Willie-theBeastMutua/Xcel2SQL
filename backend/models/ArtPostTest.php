...
/**
 * This is the model class for table "art_post_test".
 *
 ...
 */
class ArtPostTest extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
	...
	{
		return parent::find()->andWhere(['=', 'art_post_test.deleted', 0]);
	}
