...
/**
 * This is the model class for table "art_survey".
 *
 ...
 */
class ArtSurvey extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
	...
	{
		return parent::find()->andWhere(['=', 'art_survey.deleted', 0]);
	}
    ...
    public function rules()
    {
        return [
            ...
            [['Response', 'Submitted on', 'Institution', 'Course', 'Group', 'ID', 'Full name', 'Username', 'Q00_Full name', 'Q00_Email address', 'Q00', 'Q00_Sex', 'Q00_Education', 'Q00_Age', 'Q00_Country', 'Q00_Other country', 'Q00_Cadre', 'Q00_Level of service support', 'Q00_Other levels HC support', 'Q00_County', 'Q00_More than one county', 'Q00_Sub county', 'Q00_Health facility', 'Q00_MFLCode', 'Q00_Experience in health sector', 'Q00_Experience in HIV response', 'Q01_eCourse registration', 'Q03_Level of access->1', 'Q03_Level of access->2', 'Q03_Level of access->3', 'Q03_Level of access->4', 'Q03_Level of access->5', 'Q04_Level of Confidence in IT->1', 'Q04_Level of Confidence in IT->2', 'Q04_Level of Confidence in IT->3', 'Q04_Level of Confidence in IT->4', 'Q04_Level of Confidence in IT->5', 'Q05_Time in a day', 'Q06_Difficulties for the course->1', 'Q06_Difficulties for the course->2', 'Q06_Difficulties for the course->3', 'Q06_Difficulties for the course->4', 'Q07_Support needed->1', 'Q07_Support needed->2', 'Q07_Support needed->3', 'Q07_Support needed->4', 'Q07_Support needed->5', 'Q07_Support needed->6', 'Q08_Time of the day->1', 'Q08_Time of the day->2', 'Q08_Time of the day->3', 'Q08_Time of the day->4', 'Q08_Time of the day->5', 'Q08_Time of the day->6', 'Q08_Time of the day->7', 'Q08_Time of the day->8'], 'string', 'max' => 200],
            [['Q00_Carder-other'], 'string', 'max' => 500],
            [['Q02_Motivations for eLearning'], 'string', 'max' => 700],
            [['ID'], 'unique'],
        ];
    }
